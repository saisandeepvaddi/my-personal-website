...
<p align="center">
  <img src="https://res.cloudinary.com/saisandeepvaddi/image/upload/v1610914052/blog/setup-and-configure-eslint-in-vscode/problems_panel.png" alt="VSCode problems panel" />
</p>
...
<p align="center">
  <img src="https://res.cloudinary.com/saisandeepvaddi/image/upload/v1610918463/blog/setup-and-configure-eslint-in-vscode/configure_tasks_dropdown.png" alt="Configure task panel" />
</p>
...
<p align="center">
  <img src="https://res.cloudinary.com/saisandeepvaddi/image/upload/v1610919113/blog/setup-and-configure-eslint-in-vscode/run_task.png" alt="Run task dropdown" />
</p>

Choose `ESLint` task to run.

<p align="center">
  <img src="https://res.cloudinary.com/saisandeepvaddi/image/upload/v1610919113/blog/setup-and-configure-eslint-in-vscode/select_tasks_to_run.png" alt="Select task to run" />
</p>

That's it. You can now click and open the problems panel from the bottom left of the VSCode screen.

<p align="center">
  <img src="https://res.cloudinary.com/saisandeepvaddi/image/upload/v1610919346/blog/setup-and-configure-eslint-in-vscode/problem_status_bar.png" alt="Status bar problems button" />
</p>

<p align="center">
  <img src="https://res.cloudinary.com/saisandeepvaddi/image/upload/v1610919439/blog/setup-and-configure-eslint-in-vscode/problems_panel_2.png" alt="VSCode problems panel" />
</p>
